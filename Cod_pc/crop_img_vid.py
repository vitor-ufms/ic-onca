...
for path_onca in list_direct: # percorre list_direct tem end de pastas
  print(path_onca)
  path_img_vid = os.path.join(path_onca, "img_vid")

  if not os.path.exists(path_img_vid): # Não tem imagens de video
    continue
    
  oncas = glob.glob(path_img_vid + "/*") # lista com endereços de fotos de uma pasta
  nova_pasta = path_onca + "/seg_vid"

  if not os.path.exists(nova_pasta):
    os.mkdir(nova_pasta) #criar pasta seg_vid
