...
def iniciar():
   ...
   Thd1 = Thread(target=email,args=[EMAIL, PASSWORD]) # Cria uma thread para rodar o backend
   Thd1.start()
...
botao = Button(janela, text='Iniciar programa', command= iniciar) # Botao de inicio
